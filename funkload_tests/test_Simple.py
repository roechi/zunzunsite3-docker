...
#        time.sleep(0.5)
    ...
    def test_simple(self):
        ...
        if testPolynomialQuadratic2D_SSQABS:
            self.PostLongRunningProcess('/FitEquation__M___/2/Polynomial/2nd%20Order%20(Quadratic)/',
                                        [['commaConversion', 'I'],
                        ['graphSize', '320x240'],
                        ['animationSize', '0x0'],
                        ['scientificNotationX', 'AUTO'],
        ...
        if testSpline2D:
            self.PostLongRunningProcess( '/FitEquation__M___/2/Spline/Spline/',
                                         [['commaConversion', 'I'],
                        ['graphSize', '320x240'],
                        ['animationSize', '0x0'],
                        ['scientificNotationX', 'AUTO'],
        ...
        if testUserDefinedFunction2D:
            self.PostLongRunningProcess('/FitEquation__M___/2/UserDefinedFunction/UserDefinedFunction/',
                                        [['commaConversion', 'I'],
                        ['graphSize', '320x240'],
                        ['animationSize', '0x0'],
                        ['scientificNotationX', 'AUTO'],
        ...
        if testFunctionFinder2D:
            self.PostLongRunningProcess('/FunctionFinder__M___/2/',
                                        [['commaConversion', 'I'],
                        ['dataNameX', 'X Data'],
                        ['dataNameY', 'Y Data'],
        ...
        if testPolynomialLinearWithExponentialDecay2D_SSQABS:
            self.PostLongRunningProcess('/FitEquation__M___/2/Polynomial/1st%20Order%20(Linear)%20With%20Exponential%20Decay/',
                                        [['commaConversion', 'I'],
                        ['graphSize', '320x240'],
                        ['animationSize', '0x0'],
                        ['scientificNotationX', 'AUTO'],
