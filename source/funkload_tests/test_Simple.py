...
#        time.sleep(0.5)
    ...
    def test_simple(self):
        ...
        if testPolynomialQuadratic2D_SSQABS:
            self.PostLongRunningProcess('/FitEquation__F__/2/Polynomial/2nd%20Order%20(Quadratic)/',
                                        [['commaConversion', 'I'],
                        ['graphSize', '320x240'],
                        ['animationSize', '0x0'],
                        ['scientificNotationX', 'AUTO'],
        ...
        if testSpline2D:
            self.PostLongRunningProcess( '/FitEquation__F__/2/Spline/Spline/',
                                         [['commaConversion', 'I'],
                        ['graphSize', '320x240'],
                        ['animationSize', '0x0'],
                        ['scientificNotationX', 'AUTO'],
        ...
        if testUserDefinedFunction2D:
            self.PostLongRunningProcess('/FitEquation__F__/2/UserDefinedFunction/UserDefinedFunction/',
                                        [['commaConversion', 'I'],
                        ['graphSize', '320x240'],
                        ['animationSize', '0x0'],
                        ['scientificNotationX', 'AUTO'],
        ...
        if testFunctionFinder2D:
            self.PostLongRunningProcess('/FunctionFinder__F__/2/',
                        [['commaConversion', 'I'],
                        ['dataNameX', 'X Data'],
                        ['dataNameY', 'Y Data'],
