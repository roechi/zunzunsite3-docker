...
try: # newer versions of django
    urlpatterns = patterns('',
        ...
        (r"^FunctionFinder__A___/([23])/$", zunzun.views.LongRunningProcessView),
        (r"^FunctionFinderResults/([23])/$", zunzun.views.LongRunningProcessView),
        (r"^FitEquation__A___/([23])/(.+)/(.+)/$", zunzun.views.LongRunningProcessView),
    ...
    urlpatterns = [
        ...
        url(r"^FunctionFinder__A___/([23])/$", zunzun.views.LongRunningProcessView),
        url(r"^FunctionFinderResults/([23])/$", zunzun.views.LongRunningProcessView),
        url(r"^FitEquation__A___/([23])/(.+)/(.+)/$", zunzun.views.LongRunningProcessView),
