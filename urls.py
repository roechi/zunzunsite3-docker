...
try: # newer versions of django
    urlpatterns = patterns('',
        ...
        (r"^FunctionFinder__C___/([23])/$", zunzun.views.LongRunningProcessView),
        (r"^FunctionFinderResults/([23])/$", zunzun.views.LongRunningProcessView),
        (r"^FitEquation__C___/([23])/(.+)/(.+)/$", zunzun.views.LongRunningProcessView),
    ...
    urlpatterns = [
        ...
        url(r"^FunctionFinder__C___/([23])/$", zunzun.views.LongRunningProcessView),
        url(r"^FunctionFinderResults/([23])/$", zunzun.views.LongRunningProcessView),
        url(r"^FitEquation__C___/([23])/(.+)/(.+)/$", zunzun.views.LongRunningProcessView),
