...
try: # newer versions of django
    urlpatterns = patterns('',
        ...
        (r"^FunctionFinder__J___/([23])/$", zunzun.views.LongRunningProcessView),
        (r"^FunctionFinderResults/([23])/$", zunzun.views.LongRunningProcessView),
        (r"^FitEquation__J___/([23])/(.+)/(.+)/$", zunzun.views.LongRunningProcessView),
    ...
    urlpatterns = [
        ...
        url(r"^FunctionFinder__J___/([23])/$", zunzun.views.LongRunningProcessView),
        url(r"^FunctionFinderResults/([23])/$", zunzun.views.LongRunningProcessView),
        url(r"^FitEquation__J___/([23])/(.+)/(.+)/$", zunzun.views.LongRunningProcessView),
